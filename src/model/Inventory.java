...
/**
 * Inventory implementation as inventory
...
public class Inventory extends AbstractInventory {
	 ...
	 * @param cart
	 */
	public void updateInventory(AbstractInventory cart, String user, Boolean purchase) {
	 ...
	 * @param cart
	 */
	public void setInventory(AbstractInventory cart, String user) {
		item2.clear();
